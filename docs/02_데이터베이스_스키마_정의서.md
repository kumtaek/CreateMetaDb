...
**구현된 기능**: Java SQL 처리, SqlContent.db 별도 관리, Layer 분류 시스템, ERD 고아 테이블 옵션, 공통 SQL 파서, sqltext 연계  
...
- **버전**: v4.3 (실제 구현 기반)
- **주요 기능**: Layer 분류 시스템, ERD 고아 테이블 옵션, SqlContent.db 별도 관리, 정밀 매칭 보조 테이블, sqltext 기반 쿼리 관리
