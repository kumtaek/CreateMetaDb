...
erDiagram
    ...
    components ||--o{ mapper_map : maps_to
```

## 테이블 상세 정의

**총 테이블 수**: 9개 (projects, files, classes, components, tables, columns, relationships, controller_api_map, mapper_map)
