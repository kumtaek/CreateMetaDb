...
class FrontendLoadingEngine:
        ...
        try:
            ...
            for component in components:
                component_data = {
                    ...
                    'component_name': component['component_name'], 'component_type': 'JSP',
        ...
        try:
            ...
            for api_call in api_calls:
                try:
                    ...
                    if api_call.get('file_type', '').upper() == 'JSP':
    ...
    def _find_frontend_component_id(self, file_name: str, project_id: int) -> Optional[int]:
        ...
        try:
            ...
            result = self.db_utils.execute_query(query, (project_id, file_name, self.current_file_id), conn=self.conn)
    ...
    def _create_relationship(self, src_id: int, dst_id: int, rel_type: str):
        """관계 생성"""
        try:
            if self.db_utils.insert_relationship(src_id, dst_id, rel_type, conn=self.conn):
